...
public:
	...
	double Sum();					//сума чисел(елементів) - контейнера(масива)
	double Arithmetic_Mean_Abs();	//середнє арифметичне(за абсолютною величиною) - контейнера(масива)
	void Subtract_Sum_Number();		//віднямає від кожного числа суму чисел.
};